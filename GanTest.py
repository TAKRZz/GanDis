...
def generator_model():
    ...
    model.add(tf.keras.layers.Dense(8, input_shape=(4,), use_bias=False))
...
def generator_loss(fake_out):
    ...
    # print("0.9 * tf.ones_like(fake_out) :", 0.9 * tf.ones_like(fake_out))
    # print("fake_out :", fake_out)
    # quit()
    fake_out = fake_out * fake_out
    res = cross_entropy(0.9 * tf.ones_like(fake_out), fake_out)
    print("gen_loss : ", res)
...
# gen_loss = generator_loss(fake_out)
# print("gen_loss", gen_loss)
# print(cross_entropy([2, ], fake_out))
